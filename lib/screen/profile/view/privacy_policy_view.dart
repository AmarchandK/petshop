        ...
        child: SingleChildScrollView(
          child:  Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text('Our website address is: https://petvillagedubai.com/'),
              SizedBox(height: 20),
              ...
              SizedBox(height: 10),
              Text('An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. After approval of your comment, your profile picture is visible to the public in the context of your comment.'),
              SizedBox(height: 20),
              Text('Media', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 20),
              Text('Embedded content from other websites', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 20),
              Text('Who we share your data with', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              Text('If you request a password reset, your IP address will be included in the reset email.'),
              SizedBox(height: 20),
              Text('How long we retain your data', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 20),
              Text('What rights you have over your data', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              ...
              SizedBox(height: 20),
              Text('Where your data is sent', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
